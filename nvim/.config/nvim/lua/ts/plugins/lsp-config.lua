  ...
  config = function()
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(event)
        ...
        map("<leader>fb", require("telescope.builtin").git_branches, "[F]ind [B]ranch")
        map("<leader>fo", require("telescope.builtin").oldfiles, "[F]ind recently [o]pened files")
        map("<leader>fc", require("telescope.builtin").grep_string, "[F]ind string under cursor in [c]wd")
        map("<leader>fd", "<cmd>Telescope dir live_grep<CR>", "")
        map("<leader>pd", "<cmd>Telescope dir find_files<CR>", "")
